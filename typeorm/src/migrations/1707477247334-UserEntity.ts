...
export class UserEntity1707477247334 implements MigrationInterface {
    name = 'UserEntity1707477247334'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."UserEntity_status_enum" AS ENUM('student', 'teacher')`);
        await queryRunner.query(`CREATE TABLE "UserEntity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isBanned" boolean, "isAdmin" boolean, "registerAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying, "firstName" character varying, "lastName" character varying, "email" character varying, "emailVerified" character varying, "phone" character varying, "phoneVerified" character varying, "image" character varying, "imageMax" character varying, "shortInfo" character varying, "about" character varying, "experience" character varying, "slug" character varying NOT NULL, "status" "public"."UserEntity_status_enum" NOT NULL DEFAULT 'student', CONSTRAINT "UQ_47447f6c9e7eeb86726a4f7cf14" UNIQUE ("email"), CONSTRAINT "PK_f28c02cf76148cdc220d5c056ed" PRIMARY KEY ("id"))`);
